...
const OrganiserLogin = (props) => {
    ...
    const handleLogin = async () => {
        ...
        const jsonPayload = JSON.stringify({ userName });
        ...
        try {
            ...
            const response = await axios.post('http://localhost:4000/user/updateOrganizer', {
                organizerName: parsedData.userName,
